...
export function canFreePrisoner(
  ...
  // If Annalyn does not have her dog, Annalyn can free the prisoner if the prisoner is awake and the knight and archer are both sleeping, but if the prisoner is sleeping they can't be rescued:
}
